...
@DataJpaTest
public class ModifyClienteTest {
	...
	@Test
	public void cuandoModifyClienteEntoncesTrue() {
	this.dao.save(new Cliente("18862877-k", "Jhon Peter", "leyton reyes", "jean.leyton@mayor.cl", 987467823));
	 Cliente n = this.dao.findById("18862877-k").get();
	 assertNotNull(n);
	 assertTrue("ES " + n.getNombres() + " PERO DEBERÍA SER Jhon Peter", n.getNombres().equals("Jhon Peter"));
	}
